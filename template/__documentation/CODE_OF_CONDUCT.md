# {{ project_name }} Open Source Code of Conduct
...
When participating in {{ project_name }} open source community conversations and spaces, we ask individuals to follow the following guidelines:
